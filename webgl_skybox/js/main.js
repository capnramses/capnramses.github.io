...
function main() {
	...
	{ // cube map texture
		...
		create_cube_side_texture_from_file(gl.TEXTURE_CUBE_MAP_NEGATIVE_Z, "webgl_skybox/images/kegs_back.png");
		create_cube_side_texture_from_file(gl.TEXTURE_CUBE_MAP_POSITIVE_Z, "webgl_skybox/images/kegs_forward.png");
		create_cube_side_texture_from_file(gl.TEXTURE_CUBE_MAP_NEGATIVE_Y, "webgl_skybox/images/kegs_down.png");
		create_cube_side_texture_from_file(gl.TEXTURE_CUBE_MAP_POSITIVE_Y, "webgl_skybox/images/kegs_up.png");
		create_cube_side_texture_from_file(gl.TEXTURE_CUBE_MAP_NEGATIVE_X, "webgl_skybox/images/kegs_left.png");
		create_cube_side_texture_from_file(gl.TEXTURE_CUBE_MAP_POSITIVE_X, "webgl_skybox/images/kegs_right.png");

		gl.activeTexture(gl.TEXTURE0);
		gl.bindTexture(gl.TEXTURE_CUBE_MAP, cube_texture);
		// needs webgl2 gl.texParameteri(gl.TEXTURE_CUBE_MAP, gl.TEXTURE_WRAP_R, gl.CLAMP_TO_EDGE);
		// but doesn't work in modern browsers without it!:
