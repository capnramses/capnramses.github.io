	...
	function main() {
		...
		gGLSettings.loadFromFile("demos/mini/glsettings.json");
		// update HTML section
		//gGLSettings.printAll();
		
		// create a shader programme
		myShaderProg = new ShaderProgramme (glContext);
		myShaderProg.loadVertexShaderFromURL (glContext, "demos/mini/basic_vs.glsl");
		myShaderProg.loadFragmentShaderFromURL (glContext, "demos/mini/basic_fs.glsl");
		...
		console.log ("loading " + "demos/mini/dungeonDoor.json");
		myMesh = loadMeshFromJSON ("demos/mini/dungeondoor.json");
		...
		console.log ("loading " + "demos/mini/dungeonDoor.png");
		texture.image.src = "demos/mini/dungeonDoor.png";
